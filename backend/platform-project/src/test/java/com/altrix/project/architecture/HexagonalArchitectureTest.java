package com.altrix.project.architecture;
...
/** Hexagonal + naming convention rules for platform-project (#164 #166 #167). */
@AnalyzeClasses(
        packages = "com.altrix.project",
...
class HexagonalArchitectureTest {
    ...
    static final ArchRule inbound_adapters_must_not_access_persistence_directly =
            noClasses().that().resideInAPackage("..adapter.in..")
                    ...
                    .because("REST adapters must go through domain use-cases");
