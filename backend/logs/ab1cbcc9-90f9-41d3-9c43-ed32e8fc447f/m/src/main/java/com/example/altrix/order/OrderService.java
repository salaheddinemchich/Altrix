...
public class OrderService {
    ...
    private void publishOrderCreated(Order order) {
        ...
        // Kafka Producer Configuration (Assuming PubsubService now handles KafkaProducer)
        pubsubService.publish(PubsubConfig.ORDERS_CREATED, new String(payload, StandardCharsets.UTF_8));
