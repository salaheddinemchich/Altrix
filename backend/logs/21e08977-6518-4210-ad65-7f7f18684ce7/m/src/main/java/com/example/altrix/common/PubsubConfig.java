...
public final class PubsubConfig {
    ...
    public static final PubsubSubscription ORDERS_CREATED_PAYMENT_SUB = new PubsubSubscription(PROJECT_ID, "orders.created.payment-svc", PubsubSubscriptionType.PULL);
