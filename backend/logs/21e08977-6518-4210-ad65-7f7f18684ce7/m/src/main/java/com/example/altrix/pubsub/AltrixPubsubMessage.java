...
public class AltrixPubsubMessage {
    private final Map<String, String> headers; // Renamed from attributes to align with Kafka's headers concept
    private final String message; // Changed from byte[] to String, assuming UTF-8 encoding for simplicity
