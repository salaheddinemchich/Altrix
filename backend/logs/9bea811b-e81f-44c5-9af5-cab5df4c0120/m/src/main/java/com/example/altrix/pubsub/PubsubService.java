...
public interface PubsubService {
    ...
    Object getOrCreateSubscription(PubsubTopic topic, PubsubSubscription subscriptionName);
    Object createSubscription(PubsubTopic topic, PubsubSubscription subscriptionName);
    Object getOrCreateTopic(PubsubTopic topicName);
    Object createTopic(PubsubTopic topicName);
    List<String> testIAMPermissionsOnTopic(PubsubTopic topic, List<String> permissions);
    // TODO altrix: Kafka equivalent requires manual IAM setup
}