...
public class OrderEventListener {
    ...
    void onStartup() {
        ...
        // No direct equivalent for getOrCreateTopic/Sub in Kafka, using auto-creation
        ...
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest"); // Equivalent to pulling all available messages
    ...
    public void pollForOrders() {
        try {
            ...
            for (ConsumerRecord<String, String> record : records) {
                try {
                    // Assuming the message value is in the format "orderId,total" for simplicity
