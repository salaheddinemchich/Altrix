...
public class OrderService {
    ...
    private void publishOrderCreated(Order order) {
        ...
        // Kafka Producer Configuration (Assuming PubsubService is updated to handle Kafka)
        pubsubService.publish(
                PubsubConfig.ORDERS_CREATED,
                new ProducerRecord<>(PubsubConfig.ORDERS_CREATED, order.getId(), payload)
        );
