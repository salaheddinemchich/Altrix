...
import com.example.altrix.payment.Payment;
import com.example.altrix.payment.PaymentMethod;
import com.example.altrix.payment.PaymentRepository;
import com.example.altrix.payment.PaymentStatus;
...
public class PaymentService {
    ...
    private void publishPaymentCompleted(Payment payment) {
        ...
        // Kafka Producer Configuration (Assuming already set up in PubsubService)
        pubsubService.publish(
            PubsubConfig.PAYMENTS_COMPLETED, 
            new ProducerRecord<>(PubsubConfig.PAYMENTS_COMPLETED, payment.getOrderId(), payload)
        );
