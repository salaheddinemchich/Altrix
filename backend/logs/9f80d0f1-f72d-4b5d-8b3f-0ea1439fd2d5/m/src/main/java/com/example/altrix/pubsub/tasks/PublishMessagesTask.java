...
public class PublishMessagesTask extends RetryTask<RecordMetadata> {
    ...
    public RecordMetadata call() throws Exception {
        try {
            ...
            // If no messages are provided, return null or a custom indicator
            // For this example, assuming at least one message is expected, otherwise adjust logic
            throw new RuntimeException("No messages provided to publish");
        } catch (Exception e) {
