...
/**
 * Subscribes to the orders topic and processes each message, acking on success — the idiomatic Spring Kafka subscriber.
 */
@Service
public class OrderSubscriber {
    ...
    public void init() {
        ...
        log.info("Configured to listen to topic {}", PubSubConfig.ORDERS_TOPIC);
    }
    ...
    public void handle(
        ...
        // Manual acknowledgment (if auto-commit is disabled in config)
